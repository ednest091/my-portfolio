...
const person = {
    ...
    location:  'El Salvador/San Salvador',        // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
...
const social = [
    ...
    // Import new icons in /once-ui/icons.ts
    {
        name: 'GitHub',
        icon: 'github',
        link: 'https://github.com/ednest091',
    },
    {
        name: 'LinkedIn',
        icon: 'linkedin',
...
const home = {
    ...
    headline: <>Building The Backbone Of Software</>,
...
const about = {
    ...
    studies: {
        ...
        institutions: [
            {
                name: 'Francisco Gavidia University',
